...
class FilterNode extends CallLikeNode
{
	...
	public function __construct(
		public ?Php\ExpressionNode $inner,
	...
	public static function escapeFilter(?self $filter): static
	{
		return new static($filter, new IdentifierNode(self::Escape));
	}
	...
	public function print(PrintContext $context, string $expr = null): string
	{
		...
		if ($name === self::Escape) {
			...
			throw new CompileException('Filter |noescape is not expected at this place', $this->startLine);
		}
